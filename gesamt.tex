...
\begin{enumerate}
    ...
    \item erst am Schluß der Versuch eine Anbindung an das Wörterbuch der Augenheilkunde zu bekommen, gegebenenfalls durch Ergänzen mit in der Wikipedia vorhandenen Einträgen und Umbenennen von Einträgen für eine bessere Passung mit den Einträgen aus der Wikipedia.
\end{enumerate}
