...
\centering
 ...
 \draw[-] (\from) -- (\to);
 \node [above=0.25em, fill=white] at (s.north) {\textsc{pferd}};
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Der folgende Satz ist nicht richtig! Die Gramme wurden daraufhin überprüft, ob
%% es einen Wikipedia-Eintrag für sie gibt, und wenn ja als Merkmal genommen
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Satz nachfolgend abgeändert
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% SATZVORSCHLAG (hier ergänzend einfügen): Auf diese Weise identifizierte Begriffe, zu denen ein Wikipediaartikel existiert, bilden Merkmale, die dem Synset, das dem untersuchten Wikipediaartikel entspricht, zugewiesen werden. Wenn beispielsweise die Wortfolge 'Diabetes mellitus' im Abstract des Artikels 'Diabetische Rethinopathie' gefunden wurde, dann wird das Merkmal Diabetes mellitus dem Synset diabetische Rethinopathie zugeordnet.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Nachfolgendene 2 Sätze geändert
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Nachfolgendenen 2 Punkte geändert
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
